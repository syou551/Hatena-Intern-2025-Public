...
import (
	...
	"github.com/hatena/Hatena-Intern-2025/services/blog/domain"
...
// loadManifest はViteのmanifest.jsonを読み込んでパースする
func loadManifest(path string) (vite.Manifest, error) {
	...
	manifest, err := vite.ParseManifest(manifestFile)
	if err != nil {
		return nil, err
	}
	return manifest, nil
